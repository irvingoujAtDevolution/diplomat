...
{
    private unsafe RcRustHandle<Raw.RcSource> _inner;
    ...
    {
        _inner = RcRustHandle<Raw.RcSource>.Owned(handle, _destroy);
    }
    ...
    /// </remarks>
    internal unsafe RcSource(Raw.RcSource* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RcRustHandle<Raw.RcSource>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe RcSource(Raw.RcSource* handle, object[] pins)
    {
        _inner = RcRustHandle<Raw.RcSource>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe RcSource(Raw.RcSource* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RcRustHandle<Raw.RcSource>.Owned(handle, _destroy, dependencies, pins);
    }
    ...
    /// </summary>
    internal unsafe RcSource(RcRustHandle<Raw.RcSource> inner)
    {
        _inner = inner;
    }
    ...
    public RcSource View()
    {
        unsafe
        {
            ...
            GC.KeepAlive(this);
            return new RcSource(RcRustHandle<Raw.RcSource>.Borrowed(result, new IRustHandleDependency[] { this.DiplomatRetainDependency() }));
        }
    }
    ...
    public RcDependent MakeDependent()
    {
        unsafe
        {
            ...
            GC.KeepAlive(this);
            return new RcDependent(result, new IRustHandleDependency[] { this.DiplomatRetainDependency() });
        }
    }
