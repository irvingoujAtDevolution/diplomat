...
{
    private unsafe RcRustHandle<Raw.PinnedRcSource> _inner;
    ...
    {
        _inner = RcRustHandle<Raw.PinnedRcSource>.Owned(handle, _destroy);
    }
    ...
    {
        _inner = RcRustHandle<Raw.PinnedRcSource>.Owned(handle, _destroy, dependencies);
    }
    ...
    {
        _inner = RcRustHandle<Raw.PinnedRcSource>.Owned(handle, _destroy, pins);
    }
    ...
    {
        _inner = RcRustHandle<Raw.PinnedRcSource>.Owned(handle, _destroy, dependencies, pins);
    }
    ...
    /// </summary>
    internal unsafe PinnedRcSource(RcRustHandle<Raw.PinnedRcSource> inner)
    {
        _inner = inner;
    }
