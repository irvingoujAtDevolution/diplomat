...
{
    private unsafe RcRustHandle<Raw.RefListParameter> _inner;
    ...
    {
        _inner = RcRustHandle<Raw.RefListParameter>.Owned(handle, _destroy);
    }
    ...
    /// </remarks>
    internal unsafe RefListParameter(Raw.RefListParameter* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RcRustHandle<Raw.RefListParameter>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe RefListParameter(Raw.RefListParameter* handle, object[] pins)
    {
        _inner = RcRustHandle<Raw.RefListParameter>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe RefListParameter(Raw.RefListParameter* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RcRustHandle<Raw.RefListParameter>.Owned(handle, _destroy, dependencies, pins);
    }
    ...
    /// </summary>
    internal unsafe RefListParameter(RcRustHandle<Raw.RefListParameter> inner)
    {
        _inner = inner;
    }
