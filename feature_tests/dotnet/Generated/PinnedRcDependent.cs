...
public partial class PinnedRcDependent: IDisposable
{
    ...
    /// </summary>
    internal unsafe PinnedRcDependent(Raw.PinnedRcDependent* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.PinnedRcDependent>.Owned(handle, _destroy);
    ...
    /// destructor runs.
    /// </summary>
    internal unsafe PinnedRcDependent(Raw.PinnedRcDependent* handle, object[] pins)
    {
        _inner = RustHandle<Raw.PinnedRcDependent>.Owned(handle, _destroy);
        _pins = pins;
    }
    ...
    /// </summary>
    internal unsafe PinnedRcDependent(Raw.PinnedRcDependent* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.PinnedRcDependent>.Owned(handle, _destroy);
        _dependencies = dependencies;
        _pins = pins;
    ...
    /// </summary>
    internal unsafe PinnedRcDependent(RustHandle<Raw.PinnedRcDependent> inner, IRustHandleDependency[] dependencies)
    {
        _inner = inner;
        _dependencies = dependencies;
    }
