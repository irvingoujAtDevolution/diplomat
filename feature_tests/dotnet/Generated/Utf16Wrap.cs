...
{
    private unsafe RcRustHandle<Raw.Utf16Wrap> _inner;
    ...
    {
        _inner = RcRustHandle<Raw.Utf16Wrap>.Owned(handle, _destroy);
    }
    ...
    {
        _inner = RcRustHandle<Raw.Utf16Wrap>.Owned(handle, _destroy, dependencies);
    }
    ...
    {
        _inner = RcRustHandle<Raw.Utf16Wrap>.Owned(handle, _destroy, pins);
    }
    ...
    {
        _inner = RcRustHandle<Raw.Utf16Wrap>.Owned(handle, _destroy, dependencies, pins);
    }
    ...
    /// </summary>
    internal unsafe Utf16Wrap(RcRustHandle<Raw.Utf16Wrap> inner)
    {
        _inner = inner;
    }
