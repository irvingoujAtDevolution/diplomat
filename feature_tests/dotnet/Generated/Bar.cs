...
{
    private unsafe RcRustHandle<Raw.Bar> _inner;
    ...
    public Foo Foo
    {
        get
        {
            unsafe
            {
                ...
                GC.KeepAlive(this);
                return new Foo(RcRustHandle<Raw.Foo>.Borrowed(result, new IRustHandleDependency[] { this.DiplomatRetainDependency() }));
            }
        }
    }
    /// <summary>
    ...
    {
        _inner = RcRustHandle<Raw.Bar>.Owned(handle, _destroy);
    }
    ...
    /// </remarks>
    internal unsafe Bar(Raw.Bar* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RcRustHandle<Raw.Bar>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe Bar(Raw.Bar* handle, object[] pins)
    {
        _inner = RcRustHandle<Raw.Bar>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe Bar(Raw.Bar* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RcRustHandle<Raw.Bar>.Owned(handle, _destroy, dependencies, pins);
    }
    ...
    /// </summary>
    internal unsafe Bar(RcRustHandle<Raw.Bar> inner)
    {
        _inner = inner;
    }
