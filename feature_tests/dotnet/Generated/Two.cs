...
{
    private unsafe RcRustHandle<Raw.Two> _inner;
    ...
    {
        _inner = RcRustHandle<Raw.Two>.Owned(handle, _destroy);
    }
    ...
    /// </remarks>
    internal unsafe Two(Raw.Two* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RcRustHandle<Raw.Two>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe Two(Raw.Two* handle, object[] pins)
    {
        _inner = RcRustHandle<Raw.Two>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe Two(Raw.Two* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RcRustHandle<Raw.Two>.Owned(handle, _destroy, dependencies, pins);
    }
    ...
    /// </summary>
    internal unsafe Two(RcRustHandle<Raw.Two> inner)
    {
        _inner = inner;
    }
