...
{
    private unsafe RcRustHandle<Raw.One> _inner;
    ...
    {
        _inner = RcRustHandle<Raw.One>.Owned(handle, _destroy);
    }
    ...
    {
        _inner = RcRustHandle<Raw.One>.Owned(handle, _destroy, dependencies);
    }
    ...
    {
        _inner = RcRustHandle<Raw.One>.Owned(handle, _destroy, pins);
    }
    ...
    {
        _inner = RcRustHandle<Raw.One>.Owned(handle, _destroy, dependencies, pins);
    }
    ...
    /// </summary>
    internal unsafe One(RcRustHandle<Raw.One> inner)
    {
        _inner = inner;
    }
