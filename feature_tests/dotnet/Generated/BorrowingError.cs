...
{
    private unsafe RcRustHandle<Raw.BorrowingError> _inner;
    ...
    {
        _inner = RcRustHandle<Raw.BorrowingError>.Owned(handle, _destroy);
    }
    ...
    /// </remarks>
    internal unsafe BorrowingError(Raw.BorrowingError* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RcRustHandle<Raw.BorrowingError>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe BorrowingError(Raw.BorrowingError* handle, object[] pins)
    {
        _inner = RcRustHandle<Raw.BorrowingError>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe BorrowingError(Raw.BorrowingError* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RcRustHandle<Raw.BorrowingError>.Owned(handle, _destroy, dependencies, pins);
    }
    ...
    /// </summary>
    internal unsafe BorrowingError(RcRustHandle<Raw.BorrowingError> inner)
    {
        _inner = inner;
    }
